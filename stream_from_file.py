...
from supervision import get_video_frames_generator, ColorPalette, Color
...
def resolve_source(source_path: str) -> Optional[np.ndarray]:
    ...
    frame_generator = get_video_frames_generator(source_path=source_path)
